...
file_path = 'C:\\Users\\abdul\\Downloads\\text.csv'  # Update path if needed
emails_dataset = pd.read_csv(file_path, encoding='ISO-8859-1', engine='python', on_bad_lines='skip')
emails_dataset.head()


# Step 2: Handle missing values
emails_dataset[['subject', 'body']] = emails_dataset[['subject', 'body']].fillna('')

# Combine Subject and Body into a single text column
emails_dataset['Data'] = emails_dataset['subject'] + ' ' + emails_dataset['body']
...
emails_dataset = emails_dataset[emails_dataset['label'].isin(valid_classes)]
